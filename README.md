...
This framework was evaluated under extreme compression constraints ($\approx 0.08\%$ compression ratio) on two raw sensor datasets. To prevent dataset condensation collapse, manually engineered tabular features (like pre-calculated FFTs) were strictly avoided.

| Dataset | Classes | Original Size | Synthetic Size ($spc$) | K-Means Baseline | CondTSC Accuracy |
| --- | --- | --- | --- | --- | --- |
| <br>**UCI HAR** 

 | 6 | 7,352 | 6 (0.08%) | 42.83% 
